...
class Screen_prepare_to_battle (tkinter.Frame):
    ...
    def create_widgets (self):
        ...
        tkinter.Label(self, text=str(self.player1.hit_points)).grid(row=2, column=0)
        tkinter.Label(self, text=str(self.player2.hit_points)).grid(row=2, column=1)
        tkinter.Label(self, text=str(self.player1.dexterity)).grid(row=3, column=0)
        tkinter.Label(self, text=str(self.player2.dexterity)).grid(row=3, column=1)
        tkinter.Label(self, text=str(self.player1.strength)).grid(row=4, column=0)
        tkinter.Label(self, text=str(self.player2.strength)).grid(row=4, column=1)
