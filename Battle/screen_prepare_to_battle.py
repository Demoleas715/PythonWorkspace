...
class Screen_prepare_to_battle (tkinter.Frame):
    ...
    def create_widgets (self):
        ...
        tkinter.Label(self, text="Computer").grid(row=0, column=2)
        ...
        w2 = tkinter.Label(self, image = imageLarge2)
        w2.photo = imageLarge2
        
        w.grid(row=1, column=0)
        w2.grid(row=1, column=2)
        
        tkinter.Label(self, text="VS", font=("Impact", 72)).grid(row=1, column=1)
        tkinter.Label(self, text=str(self.player1.hit_points) + " HP").grid(row=2, column=0)
        tkinter.Label(self, text=str(self.player2.hit_points) + " HP").grid(row=2, column=2)
        tkinter.Label(self, text=str(self.player1.dexterity) + " Dexterity").grid(row=3, column=0)
        tkinter.Label(self, text=str(self.player2.dexterity) + " Dexterity").grid(row=3, column=2)
        tkinter.Label(self, text=str(self.player1.strength) + " Strength").grid(row=4, column=0)
        tkinter.Label(self, text=str(self.player2.strength) + " Strength").grid(row=4, column=2)
        tkinter.Button(self, text="Let's Battle!", command=self.continue_clicked).grid(row=5, column=2, sticky=tkinter.E)
